...
resource(tec, image, image('tec.jpeg')).
...
inicio:-
	...
	send(Menu,display,A,point(160,40)),

	send(Menu,display,@boton,point(210,150)),

        mostrar_imagen(Menu,tec),
        %nueva_imagen(Menu,figure,tec,point(200,300)),

        send(Menu,display,@texto,point(80,100)),

	send(Menu,display,Salir,point(245, 500)),
...
diagnosticos('Usted puede tener COVID:
	Le recomendamos que tanto usted como toda su familia se queden
	en casa de manera obligatoria, ya que al salir podria estar
	poniendo en riesgo de contagio a otras personas. Llame al 911
	para que expertos le hagan el examen correspondiente
	y asi poder confirmar su diagnostico. '):-covid,!.

diagnosticos('Usted puede tener Gripe:
	Le recomendamos quedarse en casa, descansa, recordar no
	automedicarse,beber abundantes liquidos, seguir las
	medidas higienicas,si llega a sentirse peor, acuda
	con un profesional.'):-gripe,!.

diagnosticos('Usted puede tener Influenza:
	Le recomendamos quedarse en casa, lavate las manos frecuentemente,
	evitar cambios de temperatura bruscos, si estornuda cubrete
	con el antebrazo,si usas panuelo desechable tiralo inmediatemente,
	si llegas a sentirte peor acude con un profesional.'):-influenza,!.

diagnosticos('Su diagnostico no ha resultado ser COVID, Gripe o Influenza,
	por lo cual le recomendamos acudir con un profesional medico en caso
	de presentar sintomas o sentirse mal. Es extremadamente recomendable
	que se quede en casa, que haga caso de las recomendaciones sanitarias
	y que no se automedique.').
